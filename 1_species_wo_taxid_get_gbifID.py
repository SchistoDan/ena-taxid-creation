...
def tax_request(input_csv, output_tsv):
    ...
    #reorder columns as in tempalte tax_request.tsv
...
def resolve_names_and_update_file(input_filename, output_filename):
    ...
    for index, row in input_df.iterrows():
        ...
        try:
            ...
            #handle any exceptions that occur and append the error message to the results
    ...
    for index, row in consistent_df.iterrows():
        ...
        # Append the speciesKey to the description
